...
(function (global, factory) {
  ...
  var script = {
    name: 'BClockpicker',
    components: (_components = {}, _defineProperty(_components, script$1.name, script$1), _defineProperty(_components, script$4.name, script$4), _defineProperty(_components, script$2.name, script$2), _defineProperty(_components, script$5.name, script$5), _defineProperty(_components, script$7.name, script$7), _defineProperty(_components, script$6.name, script$6), _components),
