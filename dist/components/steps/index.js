...
(function (global, factory) {
  ...
  var TabbedMixin = (function (cmp) {
    ...
    return {
      ...
      components: (_components = {}, _defineProperty(_components, script$3.name, script$3), _defineProperty(_components, SlotComponent.name, SlotComponent), _components),
      props: {
        value: {
          type: [String, Number],
          default: undefined
  ...
  script$2.__file = "src/components/steps/Steps.vue";
  ...
  script$1.__file = "src/utils/TabbedChildMixinRender.vue";

  var TabbedChildMixin = (function (parentCmp) {
    return vue.defineComponent({
      mixins: [InjectedChildMixin(parentCmp, Sorted), script$1],
      props: {
        label: String,
        icon: String,
        iconPack: String,
