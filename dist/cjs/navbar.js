...
var script$2 = {
  ...
  computed: {
    ...
    computedClasses: function computedClasses() {
      ...
      return [this.type, (_ref = {}, _rollupPluginBabelHelpers._defineProperty(_ref, FIXED_TOP_CLASS, this.fixedTop), _rollupPluginBabelHelpers._defineProperty(_ref, FIXED_BOTTOM_CLASS, this.fixedBottom), _rollupPluginBabelHelpers._defineProperty(_ref, BODY_CENTERED_CLASS, this.centered), _rollupPluginBabelHelpers._defineProperty(_ref, 'is-spaced', this.spaced), _rollupPluginBabelHelpers._defineProperty(_ref, 'has-shadow', this.shadow), _rollupPluginBabelHelpers._defineProperty(_ref, 'is-transparent', this.transparent), _ref)];
    }
  },
  watch: {
    active: {
  ...
  methods: {
    ...
    genNavbarBrandNode: function genNavbarBrandNode(createElement) {
      return createElement('div', {
        class: 'navbar-brand'
      }, [helpers.getSlot(this.$slots, 'brand'), this.genBurgerNode(createElement)]);
    },
    ...
    genMenuPosition: function genMenuPosition(createElement, positionName) {
      ...
      }, helpers.getSlot(this.$slots, positionName));
    },
